...
const ES_BUILD_CONFIG = {
  entryPoints: ['./build/sync/index.js', './build/index.js', 'build/gorgonzola_wasm_worker.js'],
  bundle: true,
  format: 'esm',
...
console.log('Building single-threaded version of Gorgonzola WebAssembly module...')
...
console.log("Building multi-threaded version of Gorgonzola WebAssembly module...");
...
console.log('Cleaning up...');
execSync("npm run clean exclude-package", { stdio: "inherit" });
console.log("Building Node.js version of Gorgonzola WebAssembly module...");
...
execSync("tar -czf gorgonzola-wasm.tar.gz package", { cwd: path.resolve("."), stdio: "inherit" });
