# gorgonzola-wasm/sync
Welcome to the documentation of `gorgonzola-wasm`, the WebAssembly build of Gorgonzola in-process property graph database management system. 
...
For package-level functions, please refer to the documentation of the module `gorgonzola-wasm` from the sidebar.
