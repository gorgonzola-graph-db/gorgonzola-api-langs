 ...
 * main class of Gorgonzola. It manages all database components.
 */
"use strict";
...
class Database {
  ...
  constructor(
    ...
    const defaultSystemConfig = new gorgonzola.SystemConfig();
    const systemConfig = new gorgonzola.SystemConfig(
      bufferPoolSize,
      maxNumThreads,
      !!enableCompression,
      !!readOnly,
    ...
    try {
      this._database = new gorgonzola.Database(databasePath, systemConfig);
    } finally {
      systemConfig.delete();
    }
