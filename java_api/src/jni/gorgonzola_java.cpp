...
#include "com_gorgonzoladb_Native.h"
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaNativeReloadLibrary(JNIEnv* env, jclass,
    jstring libPath) {
    try {
#ifdef _WIN32
// Do nothing on Windows
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaDatabaseInit(JNIEnv* env, jclass,
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaDatabaseDestroy(JNIEnv* env, jclass,
    jobject thisDB) {
    try {
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaConnectionInit(JNIEnv* env, jclass, jobject db) {
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaConnectionDestroy(JNIEnv* env, jclass,
    jobject thisConn) {
    try {
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaConnectionSetMaxNumThreadForExec(JNIEnv* env,
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaConnectionGetMaxNumThreadForExec(JNIEnv* env,
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaConnectionQuery(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaConnectionPrepare(JNIEnv* env, jclass,
    jobject thisConn, jstring query) {
    try {
        Connection* conn = getConnection(env, thisConn);
        std::string cppQuery = jstringToUtf8String(env, query);
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaConnectionExecute(JNIEnv* env, jclass,
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaConnectionInterrupt(JNIEnv* env, jclass,
    jobject thisConn) {
    try {
        Connection* conn = getConnection(env, thisConn);
        conn->interrupt();
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaConnectionSetQueryTimeout(JNIEnv* env, jclass,
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaPreparedStatementDestroy(JNIEnv* env, jclass,
    jobject thisPS) {
    try {
...
JNIEXPORT jboolean JNICALL Java_com_gorgonzoladb_Native_gorgonzolaPreparedStatementIsSuccess(JNIEnv* env,
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaPreparedStatementGetErrorMessage(JNIEnv* env,
    jclass, jobject thisPS) {
    try {
        PreparedStatement* ps = getPreparedStatement(env, thisPS);
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultDestroy(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
...
JNIEXPORT jboolean JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultIsSuccess(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultGetErrorMessage(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultGetNumColumns(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultGetColumnName(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultGetColumnDataType(JNIEnv* env,
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultGetNumTuples(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultGetQuerySummary(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jboolean JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultHasNext(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultGetNext(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jboolean JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultHasNextQueryResult(JNIEnv* env,
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultGetNextQueryResult(JNIEnv* env,
    jclass, jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultToString(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaQueryResultResetIterator(JNIEnv* env, jclass,
    jobject thisQR) {
    try {
        QueryResult* qr = getQueryResult(env, thisQR);
        qr->resetIterator();
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaFlatTupleDestroy(JNIEnv* env, jclass,
    jobject thisFT) {
    try {
        jlong fieldValue = env->GetLongField(thisFT, J_C_FlatTuple_F_ft_ref);
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaFlatTupleGetValue(JNIEnv* env, jclass,
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaFlatTupleToString(JNIEnv* env, jclass,
    jobject thisFT) {
    try {
        FlatTuple* ft = getFlatTuple(env, thisFT);
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaDataTypeCreate(JNIEnv* env, jclass, jobject id,
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaDataTypeClone(JNIEnv* env, jclass,
    jobject thisDT) {
    try {
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaDataTypeDestroy(JNIEnv* env, jclass,
    jobject thisDT) {
    try {
...
JNIEXPORT jboolean JNICALL Java_com_gorgonzoladb_Native_gorgonzolaDataTypeEquals(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaDataTypeGetId(JNIEnv* env, jclass,
    jobject thisDT) {
    try {
        auto* dt = getDataType(env, thisDT);
        std::string idStr = dataTypeToString(*dt);
        jfieldID idField =
            env->GetStaticFieldID(J_C_DataTypeID, idStr.c_str(), "Lcom/gorgonzoladb/DataTypeID;");
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaDataTypeGetChildType(JNIEnv* env, jclass,
    jobject thisDT) {
    try {
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaDataTypeGetNumElementsInArray(JNIEnv* env,
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueCreateNull(JNIEnv* env, jclass) {
    try {
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueCreateNullWithDataType(JNIEnv* env,
...
JNIEXPORT jboolean JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueIsNull(JNIEnv* env, jclass,
    jobject thisV) {
    try {
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueSetNull(JNIEnv* env, jclass, jobject thisV,
    jboolean isNull) {
    try {
        Value* v = getValue(env, thisV);
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueCreateDefault(JNIEnv* env, jclass,
    jobject dataType) {
    try {
        auto* dt = getDataType(env, dataType);
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueCreateValue(JNIEnv* env, jclass,
    jobject val) {
    try {
        Value* v = nullptr;
        if (env->IsInstanceOf(val, J_C_Boolean)) {
            ...
            int128_t res = 0;
            gorgonzola::function::decimalCast(str.c_str(), str.length(), res, type);
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueClone(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueCopy(JNIEnv* env, jclass, jobject thisValue,
    jobject otherValue) {
    try {
...
JNIEXPORT void JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueDestroy(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
        delete v;
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaCreateList___3Lcom_gorgonzoladb_Value_2(JNIEnv* env,
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaCreateList__Lcom_gorgonzoladb_DataType_2J(
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueGetListSize(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueGetListElement(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueGetDataType(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueGetValue(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueToString(JNIEnv* env, jclass,
    jobject thisValue) {
    try {
        Value* v = getValue(env, thisValue);
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaNodeValGetId(JNIEnv* env, jclass,
    jobject thisNV) {
    try {
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaNodeValGetLabelName(JNIEnv* env, jclass,
    jobject thisNV) {
    try {
        auto* nv = getValue(env, thisNV);
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaNodeValGetPropertySize(JNIEnv* env, jclass,
    jobject thisNV) {
    try {
        auto* nv = getValue(env, thisNV);
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaNodeValGetPropertyNameAt(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaNodeValGetPropertyValueAt(JNIEnv* env, jclass,
    jobject thisNV, jlong index) {
    try {
        auto* nv = getValue(env, thisNV);
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaNodeValToString(JNIEnv* env, jclass,
    jobject thisNV) {
    try {
        auto* nv = getValue(env, thisNV);
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaRelValGetId(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaRelValGetSrcId(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaRelValGetDstId(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaRelValGetLabelName(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaRelValGetPropertySize(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaRelValGetPropertyNameAt(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaRelValGetPropertyValueAt(JNIEnv* env, jclass,
    jobject thisRV, jlong index) {
    try {
        auto* rv = getValue(env, thisRV);
        uint64_t idx = static_cast<uint64_t>(index);
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaRelValToString(JNIEnv* env, jclass,
    jobject thisRV) {
    try {
        auto* rv = getValue(env, thisRV);
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaCreateMap(JNIEnv* env, jclass,
...
JNIEXPORT jobject JNICALL Java_com_gorgonzoladb_Native_gorgonzolaCreateStruct(JNIEnv* env, jclass,
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueGetStructFieldName(JNIEnv* env, jclass,
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaValueGetStructIndex(JNIEnv* env, jclass,
...
JNIEXPORT jstring JNICALL Java_com_gorgonzoladb_Native_gorgonzolaGetVersion(JNIEnv* env, jclass) {
    try {
...
JNIEXPORT jlong JNICALL Java_com_gorgonzoladb_Native_gorgonzolaGetStorageVersion(JNIEnv* env, jclass) {
    try {
...
void initGlobalClassRef(JNIEnv* env) {
    try {
        ...
        createGlobalClassRef(env, J_C_QueryResult, "com/gorgonzoladb/QueryResult");

        createGlobalClassRef(env, J_C_PreparedStatement, "com/gorgonzoladb/PreparedStatement");

        createGlobalClassRef(env, J_C_DataType, "com/gorgonzoladb/DataType");

        createGlobalClassRef(env, J_C_QuerySummary, "com/gorgonzoladb/QuerySummary");

        createGlobalClassRef(env, J_C_FlatTuple, "com/gorgonzoladb/FlatTuple");

        createGlobalClassRef(env, J_C_Value, "com/gorgonzoladb/Value");

        createGlobalClassRef(env, J_C_DataTypeID, "com/gorgonzoladb/DataTypeID");
        ...
        createGlobalClassRef(env, J_C_InternalID, "com/gorgonzoladb/InternalID");
        ...
        createGlobalClassRef(env, J_C_Connection, "com/gorgonzoladb/Connection");

        createGlobalClassRef(env, J_C_Database, "com/gorgonzoladb/Database");
