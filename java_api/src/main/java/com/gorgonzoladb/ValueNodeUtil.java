...
public class ValueNodeUtil {
    ...
    public static InternalID getID(Value value) {
        ...
        return Native.gorgonzolaNodeValGetId(value);
    }
    ...
    public static String getLabelName(Value value) {
        value.checkNotDestroyed();
        return Native.gorgonzolaNodeValGetLabelName(value);
    }
    ...
    public static long getPropertySize(Value value) {
        value.checkNotDestroyed();
        return Native.gorgonzolaNodeValGetPropertySize(value);
    }
    ...
    public static String getPropertyNameAt(Value value, long index) {
        value.checkNotDestroyed();
        return Native.gorgonzolaNodeValGetPropertyNameAt(value, index);
    }
    ...
    public static Value getPropertyValueAt(Value value, long index) {
        value.checkNotDestroyed();
        return Native.gorgonzolaNodeValGetPropertyValueAt(value, index);
    }
    ...
    public static String toString(Value value) {
        value.checkNotDestroyed();
        return Native.gorgonzolaNodeValToString(value);
    }
}
