...
public class QueryResult implements AutoCloseable {
    ...
    private void destroy() {
        checkNotDestroyed();
        if (!isOwnedByCPP) {
            Native.gorgonzolaQueryResultDestroy(this);
            destroyed = true;
        }
    }
    ...
    public boolean isSuccess() {
        checkNotDestroyed();
        return Native.gorgonzolaQueryResultIsSuccess(this);
    }
    ...
    public String getErrorMessage() {
        checkNotDestroyed();
        return Native.gorgonzolaQueryResultGetErrorMessage(this);
    }
    ...
    public long getNumColumns() {
        checkNotDestroyed();
        return Native.gorgonzolaQueryResultGetNumColumns(this);
    }
    ...
    public String getColumnName(long index) {
        checkNotDestroyed();
        return Native.gorgonzolaQueryResultGetColumnName(this, index);
    }
    ...
    public DataType getColumnDataType(long index) {
        checkNotDestroyed();
        return Native.gorgonzolaQueryResultGetColumnDataType(this, index);
    }
    ...
    public long getNumTuples() {
        checkNotDestroyed();
        return Native.gorgonzolaQueryResultGetNumTuples(this);
    }
    ...
    public QuerySummary getQuerySummary() {
        checkNotDestroyed();
        return Native.gorgonzolaQueryResultGetQuerySummary(this);
    }
    ...
    public boolean hasNext() {
        checkNotDestroyed();
        return Native.gorgonzolaQueryResultHasNext(this);
    }
    ...
    public FlatTuple getNext() {
        checkNotDestroyed();
        return Native.gorgonzolaQueryResultGetNext(this);
    }
    ...
    public boolean hasNextQueryResult() {
        checkNotDestroyed();
        return Native.gorgonzolaQueryResultHasNextQueryResult(this);
    }
    ...
    public QueryResult getNextQueryResult() {
        checkNotDestroyed();
        return Native.gorgonzolaQueryResultGetNextQueryResult(this);
    }
    ...
    public String toString() {
        if (destroyed)
            ...
            return Native.gorgonzolaQueryResultToString(this);
    }
    ...
    public void resetIterator() {
        checkNotDestroyed();
        Native.gorgonzolaQueryResultResetIterator(this);
    }
}
