...
public class GorgonzolaStruct implements AutoCloseable {
     ...
     */
    public GorgonzolaStruct(Value value) {
        structVal = value;
    }
     ...
     */
    public GorgonzolaStruct(Map<String, Value> fields) {
        if (fields.isEmpty()) {
            structVal = null;
            return;
        }
        ...
        structVal = Native.gorgonzolaCreateStruct(fieldNames, fieldValues);
    }
     ...
     */
    public GorgonzolaStruct(String[] fieldNames, Value[] fieldValues) {
    ...
    public long getNumFields() {
        ...
        return Native.gorgonzolaValueGetListSize(structVal);
    }
    ...
    public long getIndexByFieldName(String fieldName) {
        ...
        return Native.gorgonzolaValueGetStructIndex(structVal, fieldName);
    }
    ...
    public String getFieldNameByIndex(long index) {
        ...
        return Native.gorgonzolaValueGetStructFieldName(structVal, index);
    }
    ...
    public Value getValueByIndex(long index) {
        ...
        return Native.gorgonzolaValueGetListElement(structVal, index);
    }
