...
public class PreparedStatement implements AutoCloseable {
    ...
    private void destroy() {
        checkNotDestroyed();
        Native.gorgonzolaPreparedStatementDestroy(this);
        destroyed = true;
    }
    ...
    public boolean isSuccess() {
        checkNotDestroyed();
        return Native.gorgonzolaPreparedStatementIsSuccess(this);
    }
    ...
    public String getErrorMessage() {
        checkNotDestroyed();
        return Native.gorgonzolaPreparedStatementGetErrorMessage(this);
    }
