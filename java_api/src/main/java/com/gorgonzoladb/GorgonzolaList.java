...
public class GorgonzolaList implements AutoCloseable {
     ...
     */
    public GorgonzolaList(Value value) {
        listVal = value;
    }
     ...
     */
    public GorgonzolaList(Value[] values) {
        listVal = Native.gorgonzolaCreateList(values);
    }
     ...
     */
    public GorgonzolaList(DataType type, long numElements) {
        listVal = Native.gorgonzolaCreateList(type, numElements);
    }
    ...
    public long getListSize() {
        ...
        return Native.gorgonzolaValueGetListSize(listVal);
    }
    ...
    public Value getListElement(long index) {
        listVal.checkNotDestroyed();
        return Native.gorgonzolaValueGetListElement(listVal, index);
    }
