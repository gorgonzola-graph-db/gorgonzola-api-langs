...
public class Value implements AutoCloseable {
    ...
    public <T> Value(T val) {
        checkNotDestroyed();
        v_ref = Native.gorgonzolaValueCreateValue(val);
    }
    ...
    public static Value createNull() {
        return Native.gorgonzolaValueCreateNull();
    }
    ...
    public static Value createNullWithDataType(DataType data_type) {
        return Native.gorgonzolaValueCreateNullWithDataType(data_type);
    }
    ...
    public static Value createDefault(DataType data_type) {
        return Native.gorgonzolaValueCreateDefault(data_type);
    }
    ...
    private void destroy() {
        checkNotDestroyed();
        if (!isOwnedByCPP) {
            Native.gorgonzolaValueDestroy(this);
            destroyed = true;
        }
    }
    ...
    public boolean isNull() {
        checkNotDestroyed();
        return Native.gorgonzolaValueIsNull(this);
    }
    ...
    public void setNull(boolean flag) {
        checkNotDestroyed();
        Native.gorgonzolaValueSetNull(this, flag);
    }
    ...
    public void copy(Value other) {
        checkNotDestroyed();
        Native.gorgonzolaValueCopy(this, other);
    }
    ...
    public Value clone() {
        if (destroyed)
            ...
            return Native.gorgonzolaValueClone(this);
    }
    ...
    public <T> T getValue() {
        checkNotDestroyed();
        return Native.gorgonzolaValueGetValue(this);
    }
    ...
    public DataType getDataType() {
        checkNotDestroyed();
        return Native.gorgonzolaValueGetDataType(this);
    }
    ...
    public String toString() {
        if (destroyed)
            ...
            return Native.gorgonzolaValueToString(this);
    }
}
