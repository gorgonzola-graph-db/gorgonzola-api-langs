...
public class Connection implements AutoCloseable {
    ...
    public Connection(Database db) {
        ...
        conn_ref = Native.gorgonzolaConnectionInit(db);
    }
    ...
    private void destroy() {
        checkNotDestroyed();
        Native.gorgonzolaConnectionDestroy(this);
        destroyed = true;
    }
    ...
    public long getMaxNumThreadForExec() {
        checkNotDestroyed();
        return Native.gorgonzolaConnectionGetMaxNumThreadForExec(this);
    }
    ...
    public void setMaxNumThreadForExec(long numThreads) {
        checkNotDestroyed();
        Native.gorgonzolaConnectionSetMaxNumThreadForExec(this, numThreads);
    }
    ...
    public QueryResult query(String queryStr) {
        checkNotDestroyed();
        return Native.gorgonzolaConnectionQuery(this, queryStr);
    }
    ...
    public PreparedStatement prepare(String queryStr) {
        checkNotDestroyed();
        return Native.gorgonzolaConnectionPrepare(this, queryStr);
    }
    ...
    public QueryResult execute(PreparedStatement ps, Map<String, Value> m) {
        checkNotDestroyed();
        return Native.gorgonzolaConnectionExecute(this, ps, m);
    }
    ...
    public void interrupt() {
        checkNotDestroyed();
        Native.gorgonzolaConnectionInterrupt(this);
    }
    ...
    public void setQueryTimeout(long timeoutInMs) {
        checkNotDestroyed();
        Native.gorgonzolaConnectionSetQueryTimeout(this, timeoutInMs);
    }
}
