...
/**
 * The Database class is the main class of GorgonzolaDB. It manages all database
 * components.
 */
public class Database implements AutoCloseable {
    ...
    public Database(String databasePath) {
        ...
        db_ref = Native.gorgonzolaDatabaseInit(databasePath, 0, true, false, max_db_size, autoCheckpoint,
     ...
     *                                  will throw an error. Otherwise, Gorgonzola will silently ignore
    ...
    public Database(String databasePath, long bufferPoolSize, boolean enableCompression, boolean readOnly,
        ...
        db_ref = Native.gorgonzolaDatabaseInit(databasePath, bufferPoolSize, enableCompression, readOnly, maxDBSize,
    ...
    private void destroy() {
        checkNotDestroyed();
        Native.gorgonzolaDatabaseDestroy(this);
        destroyed = true;
    }
}
