...
class Database {
  ...
  constructor(
    ...
    this._database = new GorgonzolaNative.NodeDatabase(
      databasePath,
      bufferManagerSize,
      enableCompression,
      readOnly,
   ...
   */
  static getVersion() {
    return GorgonzolaNative.NodeDatabase.getVersion();
  }
  ...
  static getStorageVersion() {
    return GorgonzolaNative.NodeDatabase.getStorageVersion();
  }
   ...
   * @returns {GorgonzolaNative.NodeDatabase} the underlying native database.
