...
/**
 * Union type representing all possible value types in Gorgonzola.
 */
export type GorgonzolaValue =
    | null
    | boolean
    | number
    | bigint
...
/**
 * Represents a Gorgonzola database instance.
 */
export class Database {
    ...
    /**
     * Get the version of the Gorgonzola library.
     * @returns The version string of the library
     */
    static getVersion(): string;

    /**
     * Get the storage version of the Gorgonzola library.
...
/**
 * Represents a connection to a Gorgonzola database.
 */
export class Connection {
    ...
    execute(
        ...
        params?: Record<string, GorgonzolaValue>,
...
export class QueryResult {
     ...
     */
    getNext(): Promise<Record<string, GorgonzolaValue> | null>;

    /**
     * Get the next row synchronously.
     * @returns The next row or null if no more rows
     */
    getNextSync(): Record<string, GorgonzolaValue> | null;
     ...
     */
    each(
        resultCallback: (row: Record<string, GorgonzolaValue>) => void,
        doneCallback: () => void,
     ...
     */
    getAll(): Promise<Record<string, GorgonzolaValue>[]>;

    /**
     * Get all rows of the query result synchronously.
     * @returns All rows of the query result
     */
    getAllSync(): Record<string, GorgonzolaValue>[];
     ...
     */
    all(
        resultCallback: (rows: Record<string, GorgonzolaValue>[]) => void,
        errorCallback: (error: Error) => void
    ): void;
...
/**
 * Default export for the Gorgonzola module.
 */
declare const gorgonzola: {
