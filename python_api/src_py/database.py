...
if TYPE_CHECKING:
    ...
    from .torch_geometric_feature_store import GorgonzolaFeatureStore
    from .torch_geometric_graph_store import GorgonzolaGraphStore
...
class Database:
    ...
    def __init__(
        ...
        *,
        ...
        throw_on_wal_replay_failure: bool
            ...
            Otherwise, Gorgonzola will silently ignore the failure and replay up to where the error
            occured.
        ...
        self._database: Any = None  # (type: _gorgonzola.Database from pybind11)
        if not lazy_init:
            self.init_database()
    ...
    def get_version() -> str:
        ...
        """
        return _gorgonzola.Database.get_version()  # type: ignore[union-attr]
    ...
    def get_storage_version() -> int:
        ...
        """
        return _gorgonzola.Database.get_storage_version()  # type: ignore[union-attr]
    ...
    def init_database(self) -> None:
        ...
        if self._database is None:
            self._database = _gorgonzola.Database(  # type: ignore[union-attr]
                self.database_path,
    ...
    def get_torch_geometric_remote_backend(
    ...
    ) -> tuple[GorgonzolaFeatureStore, GorgonzolaGraphStore]:
        """
        ...
        ```python
            loader_gorgonzola = NeighborLoader(
        ...
        Returns
        -------
        feature_store : GorgonzolaFeatureStore
            Feature store compatible with torch_geometric.
        graph_store : GorgonzolaGraphStore
        ...
        return (
            GorgonzolaFeatureStore(self, num_threads),
            GorgonzolaGraphStore(self, num_threads),
        )
