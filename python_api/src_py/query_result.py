...
class QueryResult:
    ...
    def __init__(self, connection: _gorgonzola.Connection, query_result: _gorgonzola.QueryResult):  # type: ignore[name-defined]
        """
        Parameters
        ----------
        connection : _gorgonzola.Connection
            The underlying C++ connection object from pybind11.

        query_result : _gorgonzola.QueryResult
