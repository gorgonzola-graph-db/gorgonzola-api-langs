...
import gorgonzola
from gorgonzola.constants import ID, LABEL


def validate_scan_pandas_results(results: gorgonzola.QueryResult) -> None:
...
def test_scan_py_dict_map_format(conn_db_empty: ConnDB) -> None:
    ...
    # If key and value size don't match, gorgonzola sniffs it as struct.
