...
from gorgonzola.constants import ID, LABEL, SRC, DST, NODES
...
def get_result(query_result: gorgonzola.QueryResult, result_type: str, chunk_size: int | None) -> Any:
...
def test_to_arrow(conn_db_readonly: ConnDB) -> None:
    ...
    def _test_person_table(_conn: gorgonzola.Connection, return_type: str, chunk_size: int | None = None) -> None:
    ...
    def _test_movies_table(_conn: gorgonzola.Connection, return_type: str, chunk_size: int | None = None) -> None:
    ...
    def _test_utf8_string(_conn: gorgonzola.Connection, return_type: str, chunk_size: int | None = None) -> None:
    ...
    def _test_in_small_chunk_size(_conn: gorgonzola.Connection, return_type: str, chunk_size: int | None = None) -> None:
    ...
    def _test_with_nulls(_conn: gorgonzola.Connection, return_type: str, chunk_size: int | None = None) -> None:
...
def test_to_arrow_complex(conn_db_readonly: ConnDB) -> None:
    ...
    def _test_node(_conn: gorgonzola.Connection) -> None:
    ...
    def _test_node_rel(_conn: gorgonzola.Connection) -> None:
    ...
    def _test_marries_table(_conn: gorgonzola.Connection) -> None:
    ...
    def _test_recursive_rel(_conn: gorgonzola.Connection) -> None:
    ...
    def _test_serial(_conn: gorgonzola.Connection) -> None:
    ...
    def _test_blob(_conn: gorgonzola.Connection) -> None:
    ...
    def test_to_arrow1(conn: gorgonzola.Connection) -> None:
